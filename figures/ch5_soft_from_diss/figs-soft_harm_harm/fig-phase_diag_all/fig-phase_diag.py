...
#  ax.scatter(T_kb0p10_NC_quad[idx_less_zero], phi_kb0p10_NC_quad[idx_less_zero], c='k')
  ...
  for i in range(len(T_kb0p10_NC_model)-1):
    if T_kb0p10_NC_model[i+1] < T_kb0p10_NC_model[i]:
      T_kb0p10_NC_model[i+1] = T_kb0p10_NC_model[i]*(phi_kb0p10_NC_model[i]-phi_kb0p10_NC_model[i-1])/(T_kb0p10_NC_model[i]-T_kb0p10_NC_model[i-1])+T_kb0p10_NC_model[i-1]
  keep_idx = T_kb0p10_NC_model < T_kb0p10_model
  T_kb0p10_NC_model = T_kb0p10_NC_model[keep_idx]
  phi_kb0p10_NC_model = phi_kb0p10_NC_model[keep_idx]

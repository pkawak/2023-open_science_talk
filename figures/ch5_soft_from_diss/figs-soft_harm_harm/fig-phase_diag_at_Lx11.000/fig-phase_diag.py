...
WL_A_file = "../Lx11.000_kb0.10_WLMC_Ts.out"
WL_B_file = "../Lx11.000_kb1.00_WLMC_Ts.out"
WL_C_file = "../Lx11.000_kb10.0_WLMC_Ts.out"
Lx_A      = 11.000
Lx_B      = 11.000
Lx_C      = 11.000
...
ax.text(0.8, 0.5 , 'Melt'   , weight='bold', color='k', fontsize=12, fontname='dejavusans', transform = ax.transAxes)
ax.text(0.05, 0.2, 'Crystal', weight='bold', color='k', fontsize=12, fontname='dejavusans', transform = ax.transAxes)
ax.text(0.45, 0.35, 'Nematic', weight='bold', color='k', fontsize=12, fontname='dejavusans', transform = ax.transAxes)

...
WL_A_file = "../Lx15.000_kb0.10_WLMC_results.out"
WL_B_file = "../Lx15.000_kb1.00_WLMC_results.out"
WL_C_file = "../Lx15.000_kb10.0_WLMC_results.out"
Lx_A      = 15.000
Lx_B      = 15.000
Lx_C      = 15.000
...
multiplier = 1/Nc/Nb
ax[0].plot(WL_A_df["Tr"], WL_A_df["Em"]/kb_A*multiplier, label=label_prefix+str(kb_A))
ax[0].plot(WL_B_df["Tr"], WL_B_df["Em"]/kb_B*multiplier, label=label_prefix+str(kb_B))
ax[0].plot(WL_C_df["Tr"], WL_C_df["Em"]/kb_C*multiplier, label=label_prefix+str(kb_C))
...
ax[1].plot(WL_A_df["Tr"], WL_A_df["P2"], label=label_prefix+str(kb_A))
ax[1].plot(WL_B_df["Tr"], WL_B_df["P2"], label=label_prefix+str(kb_B))
ax[1].plot(WL_C_df["Tr"], WL_C_df["P2"], label=label_prefix+str(kb_C))
ax[1].set_ylabel(r"$P_{2}$", fontsize=10, labelpad=9)
ax[1].tick_params(axis='both', labelsize=8)
#ax[1].set_ylim(0.2,1)

ax[2].plot(WL_A_df["Tr"], WL_A_df["n6"], label=label_prefix+str(kb_A))
ax[2].plot(WL_B_df["Tr"], WL_B_df["n6"], label=label_prefix+str(kb_B))
ax[2].plot(WL_C_df["Tr"], WL_C_df["n6"], label=label_prefix+str(kb_C))
ax[2].set_ylabel(r"$n_{Q_{6}}$", fontsize=10, labelpad=9.5)
ax[2].tick_params(axis='both', labelsize=8)
ax[2].set_ylim(0,0.2)

multiplier = 1/Nc #/Nb
ax[3].plot(WL_A_df["Tr"], WL_A_df["Cv"]*multiplier, label=label_prefix+str(kb_A))
ax[3].plot(WL_B_df["Tr"], WL_B_df["Cv"]*multiplier, label=label_prefix+str(kb_B))
ax[3].plot(WL_C_df["Tr"], WL_C_df["Cv"]*multiplier, label=label_prefix+str(kb_C))

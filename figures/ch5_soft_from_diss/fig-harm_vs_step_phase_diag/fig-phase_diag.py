...
# plot points
ax.scatter(T_HTS_scat   , phi_HTS_scat   , color='r', marker='+', zorder=2, label=r"IN stepwise")#$T^{\mathrm{HTS}}_{\mathrm{IN}}$")
ax.scatter(T_HTS_NC_scat, phi_HTS_NC_scat, color='r', marker='*', zorder=2, label=r"IC stepwise")#$T^{\mathrm{HTS}}_{\mathrm{IC}}$")
ax.scatter(T_HTH_scat   , phi_HTH_scat   , color='b', marker='+', zorder=2, label=r"IN harmonic")#$T^{\mathrm{HTH}}_{\mathrm{IN}}$")
ax.scatter(T_HTH_NC_scatt, phi_HTH_NC_scatt, color='b', marker='*', zorder=2, label=r"NC harmonic")#$T^{\mathrm{HTH}}_{\mathrm{IC}}$")

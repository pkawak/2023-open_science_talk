...
#  print(m3, i3)
  ...
  if do_HTH:
    ax1.plot(T_HTH_model   , phi_HTH_model   , color='b', ls='--', dashes=(5, 3), zorder=1)#, label="IN")
    ax1.plot(T_HTH_NC_model, phi_HTH_NC_model, color='b', ls='--', dashes=(5, 3), zorder=1)#, label="NC")
  if do_kb0p10:
...
#  ax1.scatter(T_kb0p10_NC_quad[idx_less_zero], phi_kb0p10_NC_quad[idx_less_zero], c='k')
  ...
  if do_HTH:
    ax0.plot(T_HTH_model   , phi_HTH_model   , color='b', ls='--', dashes=(5, 3), zorder=1)#, label="IN")
    ax0.plot(T_HTH_NC_model, phi_HTH_NC_model, color='b', ls='--', dashes=(5, 3), zorder=1)#, label="NC")
  if do_kb0p10:

...
if fit:
  ...
  ax.plot(T_IC_model, phi_IC_model, color='r', zorder=1)
...
ax.set_xlabel(r"Reduced temperature, $T_{r}$", fontsize=12, labelpad=4)
ax.set_ylabel(r"Volume fraction, $\phi$", fontsize=12, labelpad=4.8)

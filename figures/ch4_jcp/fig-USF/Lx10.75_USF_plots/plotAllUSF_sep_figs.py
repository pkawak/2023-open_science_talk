...
fig0, ax0 = plt.subplots(1, 1, figsize=(3.75, 2.92), constrained_layout=False)
im0 = ax0.imshow(F_2d, interpolation='bilinear', cmap=cm.get_cmap('coolwarm', 20),
               origin='lower', extent=[0,1,0,1])
#ax0.set_title(r"$F/\epsilon$")

fig1, ax1 = plt.subplots(1, 1, figsize=(3.75, 2.92), constrained_layout=False)
...
fig2, ax2 = plt.subplots(1, 1, figsize=(3.75, 2.92), constrained_layout=False)
im2 = ax2.imshow(mTS_2d, interpolation='bilinear', cmap=cm.get_cmap('coolwarm', 20),
               origin='lower', extent=[0,1,0,1])#, norm=LogNorm(vmin=np.amin(mTS_2d), vmax=np.amax(mTS_2d)))
#ax2.set_yscale('log')
...
fig0.subplots_adjust(left=0.165, bottom=0.15, right=0.92, top=0.98, wspace=None, hspace=None)
fig1.subplots_adjust(left=0.165, bottom=0.15, right=0.87, top=0.98, wspace=None, hspace=None)
fig2.subplots_adjust(left=0.165, bottom=0.15, right=0.83, top=0.98, wspace=None, hspace=None)

...
num_x_points = 2
num_y_points = 5
x_label_list = [ round((rangeh1-rangel1)/(num_x_points-1)*(i)+rangel1, 2) for i in range(num_x_points) ]
y_label_list = [ round((rangeh2-rangel2)/(num_y_points-1)*(i)+rangel2, 2) for i in range(num_y_points) ]
...
fig.savefig("subfig-pathway_soft_cryst.pdf")
...
fig.savefig("subfig-pathway_soft_cryst_small.pdf")
...
fig.savefig("subfig-pathway_soft_cryst_smaller.pdf")
...
#fig.savefig("subfig-pathway_soft_cryst_mark.pdf")
...
#fig.savefig("subfig-pathway_soft_cryst_MFEP.pdf")
plt.close()

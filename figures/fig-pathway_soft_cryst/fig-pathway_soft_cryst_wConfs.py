...
\\begin{picture}(3.75,2.92)
  \\put(0.00, 0.00){\\includegraphics[]{subfig-pathway_soft_cryst.pdf}}
  \\put(0.70, 1.80){\\includegraphics[scale=1.50]{trans_chains.pdf}}
%  \\put(0.40, 0.95){\\includegraphics[]{melt_chains.pdf}}
  \\put(2.20, 2.20){\\includegraphics[scale=2.00]{crystal_chains.pdf}}

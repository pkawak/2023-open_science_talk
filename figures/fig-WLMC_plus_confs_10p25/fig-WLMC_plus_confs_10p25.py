...
\\begin{picture}(3.0,2.85)
  \\put(0.0, 0.0) {\\includegraphics[]{subfig-WLMC_10.25.pdf}}
  \\put(2.05, 1.4 ){\\includegraphics[trim={90 240 90 240}, clip, scale=0.078]{../configs_lowT/melt.png}}
  \\put(0.68, 1.3 ){\\includegraphics[trim={90 240 90 240}, clip, scale=0.078]{../configs_lowT/cryst.png}}

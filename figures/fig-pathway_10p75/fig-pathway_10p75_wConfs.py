...
\\begin{picture}(3.75,2.92)
  \\put(0.00, 0.00){\\includegraphics[]{subfig-pathway_10p75_mark.pdf}}
  \\put(0.75, 0.40){\\includegraphics[scale=1.85]{melt_chains.pdf}}
  \\put(2.08, 2.10){\\includegraphics[scale=1.5]{trans_chains.pdf}}

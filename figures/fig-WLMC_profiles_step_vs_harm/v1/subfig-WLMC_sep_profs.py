...
test=0
fig, axs = plt.subplots(1, 3, sharey=True, figsize=(5.5,2.92), constrained_layout=test)
...
axs[0].set_ylabel(r"$T_{r}$", fontsize=10, labelpad=1)
...
if test == 0:
  fig.subplots_adjust(left=0.07, bottom=0.12, right=0.998, top=0.996, hspace=0.05)

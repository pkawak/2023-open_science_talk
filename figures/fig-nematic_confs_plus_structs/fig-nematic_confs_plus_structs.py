...
\\newcommand{\mynematiclabel}[1]{%
  \\begin{tikzpicture}
    \\node[fill=OliveGreen, rounded corners=2pt, align=center, inner sep=1.5pt]{\\textcolor{white}{\\LARGE{#1}}};
  \\end{tikzpicture}%
  }
...
\\begin{picture}(5.96,3.2)
  \\put(0.00, 2.40 ){\\mynematiclabel{Nematic $(\phi=0.407,T_{r}=0.001)$}}
  \\put(0.00, 0.10 ){\\includegraphics[trim={90 240 90 240}, clip, scale=0.29]{../configs_lowT/nematic.png}}
  ...
  \\put(3.34, 0.00){\\includegraphics[]{structs/subfig-nematic.x.y1.z1.3D.dat.pdf}}
  \\put(4.66, 0.65 ){\\includegraphics[]{structs/subfig-nematic.x1.y.z1.3D.dat.pdf}}
  \\put(3.34, 1.4 ){\\includegraphics[]{structs/subfig-nematic.x1.y1.z.3D.dat.pdf}}

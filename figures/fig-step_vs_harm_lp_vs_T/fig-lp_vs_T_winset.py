...
legend_elements = [
                   Line2D([0], [0], color='m', label='discrete rods'),
                   Line2D([0], [0], color='b', label='continuous rods'),
#                   Line2D([0], [0], marker='+', color='k', markeredgewidth=1.5, label=r'$\kappa^{*} = 600$',
                   Line2D([0], [0], marker='+', color='k', markeredgewidth=1.5, label=r'springs $\frac{\epsilon_{l}}{\epsilon_{\theta}} = 600$',
                          markerfacecolor='k', markersize=5),# handlelength=1),
#                   Line2D([0], [0], marker='*', color='w', label=r'$k_{b}^{*} = 20$',
                   Line2D([0], [0], marker='*', color='w', label=r'springs $\frac{\epsilon_{l}}{\epsilon_{\theta}} = 30$',

...
\\begin{picture}(5.96,3.2)
  \\put(0.05, 2.40 ){\\mycrystlabel{Crystal $(\phi=0.471,T_{r}=0.001)$}}
  \\put(0.00, 0.10 ){\\includegraphics[trim={90 240 90 240}, clip, scale=0.29]{../configs_lowT/cryst.png}}
...
%  \\put(3.34, 0.00){\\includegraphics[]{structs/subfig-cryst.x.y1.z1.3D.dat.pdf}}
%  \\put(4.66, 0.65 ){\\includegraphics[]{structs/subfig-cryst.x1.y.z1.3D.dat.pdf}}
%  \\put(3.34, 1.4 ){\\includegraphics[]{structs/subfig-cryst.x1.y1.z.3D.dat.pdf}}

...
%Preamble
\\usepackage[margin=0in,paperwidth=3.1in,paperheight=2.92in]{geometry}
\\usepackage{graphicx}
...
\\centering
\\begin{picture}(3.1,2.92)
  \\put(0.00, 0.00){\\includegraphics[]{subfig-pathway_ToC_mark.pdf}}
  \\put(0.31, 0.70){\\includegraphics[scale=1.85]{melt_chains.pdf}}

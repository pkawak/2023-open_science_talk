...
#  T_HTH_NC_model = T_HTH_NC_model[del_idx]
  ...
  T_HTH_NC_model = T_HTH_NC_model[keep_idx]
  phi_HTH_NC_model = phi_HTH_NC_model[keep_idx]
  ax.plot(T_HTH_model   , phi_HTH_model   , color='b', ls='-', zorder=1)
  ax.plot(T_HTH_NC_model, phi_HTH_NC_model, color='b', ls='-', zorder=1)
  ax.plot(T_HTH_NC_assum, phi_HTH_NC_assum, color='b', ls='--', zorder=1)

  idx = (np.abs(phi_HTH_model-phi_HTH_cryst)).argmin()
  T_max_ = T_HTH_model[idx]
 # ax.hlines(phi_HTH_cryst, 0, T_max_, color='k', ls="--")

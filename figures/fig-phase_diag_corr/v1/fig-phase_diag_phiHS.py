...
Ts_files = "data_files/hard_harm_Ts.out"
do_HTH = 1
...
fig, ax = plt.subplots(1, 1, figsize=(3.25,3.1))
# plot points
ax.scatter(T_HTH_scat      , phi_HTH_scat          , marker='+', zorder=2, alpha=1.0, color='b'                              , label=r"$IN$ hard")
ax.scatter(T_HTH_NC_scatt  , phi_HTH_NC_scatt      , marker='*', zorder=2, alpha=1.0, color='b'                              , label=r"$NC$ hard")
ax.scatter(T_kb0p10_scat   , phi_mod_kb0p10_scat   , marker='+', zorder=2, alpha=1.0, color='r'                              , label=r"$IN$ $k_{b}^{*}=0.1$")
ax.scatter(T_kb1p00_scat   , phi_mod_kb1p00_scat   , marker='+', zorder=2, alpha=1.0, color='m'                              , label=r"$IN$ $k_{b}^{*}=1$")
ax.scatter(T_kb10p0_scat   , phi_mod_kb10p0_scat   , marker='+', zorder=2, alpha=1.0, color='c'                              , label=r"$IN$ $k_{b}^{*}=10$")
ax.scatter(T_kb0p10_NC_scat, phi_mod_kb0p10_NC_scat, marker='*', zorder=2, alpha=1.0, s=60, edgecolors='r', facecolors='r'   , label=r"$NC$ $k_{b}^{*}=0.1$")
ax.scatter(T_kb1p00_NC_scat, phi_mod_kb1p00_NC_scat, marker='*', zorder=2, alpha=1.0      , edgecolors='m', facecolors='m'   , label=r"$NC$ $k_{b}^{*}=1$")
ax.scatter(T_kb10p0_NC_scat, phi_mod_kb10p0_NC_scat, marker='*', zorder=2, alpha=1.0, s=35, edgecolors='c', facecolors='none', label=r"$NC$ $k_{b}^{*}=10$")
...
#  ax.scatter(T_kb0p10_NC_quad[idx_less_zero], phi_mod_kb0p10_NC_quad[idx_less_zero], c='k')
...
#  print(m3, i3)
  ...
  if do_HTH:
    ax.plot(T_HTH_model   , phi_HTH_model   , color='b', ls='-', zorder=1)#, dashes=(5, 3))#, label="IN")
    ax.plot(T_HTH_NC_model, phi_HTH_NC_model, color='b', ls='-', zorder=1)#, dashes=(5, 3))#, label="NC")
    ax.plot(T_HTH_NC_assum, phi_HTH_NC_assum, color='b', ls='--', zorder=1)#, dashes=(5, 3))#, label="NC")
#  if do_kb0p10:
...
plt.subplots_adjust(left=0.141, top=0.9985, bottom=0.118, right=0.974)

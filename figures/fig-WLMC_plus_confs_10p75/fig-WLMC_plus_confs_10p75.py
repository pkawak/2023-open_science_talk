...
%Preamble
\\usepackage[margin=0in,paperwidth=3.0in,paperheight=2.85in]{geometry}
\\usepackage{graphicx}
...
\\centering
\\begin{picture}(3.0,2.85)
  \\put(0.0, 0.0) {\\includegraphics[]{subfig-WLMC_10.75.pdf}}
  \\put(2.1, 1.40 ){\\includegraphics[trim={90 240 90 240}, clip, scale=0.078]{../configs_lowT/melt.png}}
  \\put(0.6, 1.25 ){\\includegraphics[trim={90 240 90 240}, clip, scale=0.078]{../configs_lowT/nematic.png}}

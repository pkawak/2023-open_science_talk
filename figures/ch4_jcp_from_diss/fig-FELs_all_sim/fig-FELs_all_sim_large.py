...
\\begin{picture}(9.0,6.5)
  \\put(0.075,0.00 ){\\includegraphics[]{subfig-FEL_p438_sim_large.pdf}}
  \\put(1.696,3.09 ){\\mylabel{(b) $\phi = 0.438$}}
  \\put(4.569,0.00 ){\\includegraphics[]{subfig-FEL_p407_sim_large.pdf}}
  \\put(6.162,3.09 ){\\mylabel{(d) $\phi = 0.407$}}
  \\put(5.815,3.32 ){\\includegraphics[]{subfig-FEL_p379_sim_large.pdf}}
  \\put(7.20,6.3 ){\\mylabel{(e) $\phi = 0.379$}}
  \\put(2.8,3.32 ){\\includegraphics[]{subfig-FEL_p428_sim_large.pdf}}
  \\put(4.2,6.3 ){\\mylabel{(c) $\phi = 0.428$}}
  \\put(-0.15,3.32 ){\\includegraphics[]{subfig-FEL_p471_sim_large.pdf}}

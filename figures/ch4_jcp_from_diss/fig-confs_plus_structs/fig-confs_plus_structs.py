...
\\begin{picture}(6.5,4.1)
  \\put(4.42, 2.5 ){\\includegraphics[trim={98 244 117 235}, clip, scale=0.19]{configs_lowT/cryst.png}}
  \\put(4.82, 2.7  ){\\yourxlabel{x}}
  \\put(4.57, 2.6  ){\\yourylabel{y}}
  \\put(4.77, 2.45  ){\\yourzlabel{z}}
  \\put(4.62, 2.5) {\\includegraphics[trim={140 140 710 733}, clip, scale=0.19]{configs_lowT/axes.png}}
  \\put(2.25, 2.5 ){\\includegraphics[trim={96 242 96 245}, clip, scale=0.19]{configs_lowT/nematic.png}}
  \\put(2.65, 2.7  ){\\yourxlabel{x}}
  \\put(2.40, 2.6  ){\\yourylabel{y}}
  \\put(2.60, 2.45  ){\\yourzlabel{z}}
  \\put(2.45, 2.5) {\\includegraphics[trim={140 140 710 733}, clip, scale=0.19]{configs_lowT/axes.png}}
  \\put(0.07, 2.5 ){\\includegraphics[trim={90 243 90 244}, clip, scale=0.19]{configs_lowT/melt.png}}
  \\put(0.40, 2.7  ){\\yourxlabel{x}}
  \\put(0.15, 2.6  ){\\yourylabel{y}}
  \\put(0.35, 2.45  ){\\yourzlabel{z}}
  \\put(0.2, 2.5  ){\\includegraphics[trim={140 140 710 733}, clip, scale=0.19]{configs_lowT/axes.png}}
  ...
  \\put(5.0, 3.89 ){\\mycrystlabel{(c) Crystal}}

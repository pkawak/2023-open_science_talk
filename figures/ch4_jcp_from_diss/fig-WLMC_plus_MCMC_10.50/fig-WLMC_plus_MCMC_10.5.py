...
ax[0].axvline(x=0.248, color='b', alpha=0.5, ls=':', label=r'$T_{r}=0.248$')
...
ax[1].axvline(x=0.248, color='b', alpha=0.5, ls=':')
...
ax[2].axvline(x=0.248, color='b', alpha=0.5, ls=':')
...
ax[2].set_yticks([0.395, 0.40, 0.405, 0.41])
plt.subplots_adjust(left=0.2, top=0.975, bottom=0.07, right=0.995, hspace=0.1)
plt.savefig("fig-WLMC_plus_MCMC_10.5.pdf")

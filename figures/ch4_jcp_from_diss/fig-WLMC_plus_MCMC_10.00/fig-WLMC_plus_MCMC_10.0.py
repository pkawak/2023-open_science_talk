...
ax[0].axvline(x=0.3736, color='b', alpha=0.5, ls=':', label=r'$T_{r}=0.374$')
...
ax[1].axvline(x=0.3736, color='b', alpha=0.5, ls=':')
...
ax[2].axvline(x=0.3736, color='b', alpha=0.5, ls=':')
...
plt.savefig("fig-WLMC_plus_MCMC_10.0.pdf")
